...
contract StarNotary is ERC721 {
    ...
    // create a default star name and symbol
    constructor() public {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        //2. Passing two star tokenIds you will need to check if the owner of _tokenId1 or _tokenId2 is the sender
        require(msg.sender == owner1 || msg.sender == owner2, "You can't exchange a Star you don't own");

        //3. You don't have to check for the price of the token (star)
