...
it('lets user2 buy a star and decreases its balance in ether', async() => {
    ...
    await instance.buyStar(starId, {from: user2, value: balance, gasPrice:88011441});
...
it('can add the star name and star symbol property', async() => {
    let name = "Udacity Star Notary";
    let symbol = "USN";
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let starId = 9;
    let starName = 'Awesome Test Star';
